            ...
            <main className="flex-grow flex flex-col items-center justify-center px-4">
                ...
                <div className="w-full max-w-3xl mx-auto space-y-6">
                    ...
                    <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 text-white">
                        ...
                        {errorLoadingLinks && <p className="text-red-500">{errorLoadingLinks}</p>}

                        {!loadingLinks && !errorLoadingLinks && links.length === 0 && (
                            <p>Nenhum link encurtado ainda. Comece encurtando um link acima!</p>
                        )}
                            ...
                            <div className="overflow-x-auto">
                                <table className="min-w-full table-auto">
                                    <thead className="border-b border-white/20">
                                        <tr>
                                            <th className="text-left p-3 font-semibold">Link Original</th>
                                            <th className="text-left p-3 font-semibold">Link Encurtado</th>
                                    ...
                                    <tbody>
                                        {links.map((link) => (
                                            <tr key={link.id} className="border-b border-white/10">
                                                ...
                                                <td className="p-3">
                                                    {editingLinkId === link.id ? (
                                                        <input
                                                            ...
                                                            onChange={(e) => setEditedShortenedUrl(e.target.value)}
                                                            className="bg-white/5 text-white p-2 rounded focus:outline-none"
                                                        />
                                                    ) : (
                                                ...
                                                <td className="p-3">{formatDate(link.expiration_date)}</td>
